            ...
            <ul className="sidebar-menu" data-widget="tree">
                <li className="active treeview menu-open">
                    ...
                    <ul className="treeview-menu">
                        <li className="active"><a ><i className="fa fa-circle"></i> All</a></li>
                        <li><a ><i className="fa fa-circle-o"></i> Empty Shelves
                    <span className="pull-right-container">
                                <small className="label pull-right bg-aqua">3</small>
                            </span></a></li>
                        <li><a ><i className="fa fa-circle-o"></i> Under Refill</a></li>
                        <li><a ><i className="fa fa-circle-o"></i> Inventory Mismatch</a></li>
                    </ul>
                </li>
                <li>
                    <a >
